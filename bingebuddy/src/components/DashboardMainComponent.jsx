...
const DashboardMainComponent = () => {
  ...
  return (
    <div className="flex">
      <div className={`${open ? "w-72" : "w-20"} bg-gold duration-300 h-screen p-5 pt-8 relative`}>
        <img
          src="../src/Images/Dashboard-Images/control.png"
          className={`absolute cursor-pointer rounded-full -right-3 top-9 w-7 border-2 border-gold ${!open && "rotate-180"}`}
        />
        ...
        <ul className="pt-6">
          {Menus.map((menu, index) => (
            ...
            >
              <a href={menu.path} className="nav-link text-truncate flex items-center gap-x-2">
